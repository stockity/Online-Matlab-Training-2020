function result = batchmyBatch(inDir, outDir)
%batchmyBatch Batch process images using myBatch
% RESULT = batchmyBatch(INDIR, OUTDIR) processes each file in INDIR
% using the function myBatch.
%
% The following fields from the output of myBatch are written with their
% corresponding file format to the output directory OUTDIR:
%    RGB saved as tiff format
%
...
if(nargin<1)
    inDir = 'C:\Users\Master\Documents\GitHub\Online-Matlab-Training-2020\Flower';
end
...
% Process each image using myBatch
