function [bestFitness,bestSol] = TLBO_OPT3(FitnessFunction,lowerBound,upperBound)
...
%%  Starting the TLBO
f = NaN(Np,3);      % Array to hold solution(fitness score) for polution
BestFitIter = NaN(T+1,3);   % Vector to store best fitness value in every iteration
