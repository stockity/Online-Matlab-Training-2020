function [BW,maskedRGBImage] = OrangeFlower(RGB)
...
shiftVec = [0.389717 0.224796 0.654907];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [0.964874 -0.366015 0.000000 -0.283032;
    0.210758 0.520287 0.691964 -0.776257;
    0.314068 0.775324 -0.464348 8.000987;
...
hPoints(1).data = [-0.176070 -0.210864;
    -0.345219 -0.275745;
    -0.275569 -0.901385;
    -0.295469 -1.188716;
    0.216954 -0.804063;
